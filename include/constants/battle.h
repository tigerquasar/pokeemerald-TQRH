...
#define BITTEN_BY(battler) (battler + 1)
...
enum __attribute__((packed)) MoveEffect
{
    ...
    MOVE_EFFECT_SP_DEF_MINUS_1_COUNTER,
    MOVE_EFFECT_ACC_MINUS_1_COUNTER,

    // Stat Plus 1
    MOVE_EFFECT_ATK_PLUS_1_COUNTER,
    MOVE_EFFECT_DEF_PLUS_1_COUNTER,
    MOVE_EFFECT_SPD_PLUS_1_COUNTER,
    MOVE_EFFECT_SP_ATK_PLUS_1_COUNTER,
    MOVE_EFFECT_SP_DEF_PLUS_1_COUNTER,

    MOVE_EFFECT_DEF_PLUS_2_COUNTER,
