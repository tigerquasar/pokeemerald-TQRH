...
enum __attribute__((packed)) MoveEffect
{
    ...
    // Stat Minus 1
    MOVE_EFFECT_ATK_MINUS1_COUNTER,
    MOVE_EFFECT_DEF_MINUS1_COUNTER,
    MOVE_EFFECT_SPEATK_MINUS1_COUNTER,
    MOVE_EFFECT_SPEDEF_MINUS1_COUNTER,
    MOVE_EFFECT_SPD_MINUS1_COUNTER,

    /*
    // Stat Minus 2
    MOVE_EFFECT_ATK_MINUS2_COUNTER,
    MOVE_EFFECT_DEF_MINUS2_COUNTER,
    MOVE_EFFECT_SPEATK_MINUS2_COUNTER,
    MOVE_EFFECT_SPEDEF_MINUS2_COUNTER,
    MOVE_EFFECT_SPE_MINUS2_COUNTER,
    */
