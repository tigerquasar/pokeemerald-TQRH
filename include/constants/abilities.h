...
enum __attribute__((packed)) Ability
{
    ...
    //Custom
    ABILITY_SPARRING_PARTNER = 311,
    ABILITY_AIR_BENDER = 312,
    ABILITY_PARTY_POOPER = 313,
    ABILITY_METAL_ARMOR = 314,
    ABILITY_SWORD_BREAKER = 315,
    ABILITY_DUELLIST = 316,
    ABILITY_THICK_SKIN = 317,
    ABILITY_REGENPOWDER = 318,
    ABILITY_CANNON = 319,
    ABILITY_AURA_WALL = 320,
    ABILITY_MUSCULAR_LEG = 321,
    ABILITY_GRAPPLER = 322,
    ABILITY_HEAVYWEIGHT = 323,
    ABILITY_BRICK_WALL = 324,
    ABILITY_TAIL = 325,
    ABILITY_INDOMITABLE = 326,
    ABILITY_RED_DOT = 327,
    ABILITY_REFRACTION = 328,
    ABILITY_REINFORCED_BEAK = 329, 
    ABILITY_SHARP_HORN = 330,
    ABILITY_ETHERAL_BODY = 331,
    ABILITY_LUMEN = 332,
