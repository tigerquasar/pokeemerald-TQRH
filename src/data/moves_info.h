...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_ICE_PUNCH] =
    {
        ...
        .punchingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FROSTBITE_COUNTER,
            .chance = 12,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 20 : 20,
        }),
    ...
    [MOVE_BITE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FLINCH_COUNTER,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 20 : 10,
        }),
    ...
    [MOVE_ACID] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
            .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = B_UPDATED_MOVE_DATA >= GEN_4 ? MOVE_EFFECT_SP_DEF_MINUS_1_COUNTER : MOVE_EFFECT_DEF_MINUS_1,
    ...
    [MOVE_SLUDGE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON_COUNTER,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 20 : 40,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_FIRE_BLAST] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN_COUNTER,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 12 : 30,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED : CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_DIAMOND_STORM] =
    {
        ...
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = B_UPDATED_MOVE_DATA >= GEN_7 ? MOVE_EFFECT_DEF_PLUS_2_COUNTER:  MOVE_EFFECT_DEF_PLUS_1,
            .self = TRUE,
            .chance = 30,
        }),
    ...
    [MOVE_URANIUM_WIND] =
    {
        .name = COMPOUND_STRING("Uranium Wind"),
        .description = COMPOUND_STRING(
            "Exhales a toxic breath on the\n"
            "foes. May inflict poison."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 100,
        .type = TYPE_POISON,
        .accuracy = 90,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY},
        .battleAnimScript = gBattleAnimMove_UraniumWind,
        .validApprenticeMove = TRUE,
    },

    [MOVE_EMBER2] =
    {
        .name = COMPOUND_STRING("Ember2"),
        .description = COMPOUND_STRING(
            "A weak fire attack that may\n"
            "inflict a burn.2"),
        .effect = EFFECT_HIT,
        ...
        //.alwaysHitsInRain = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DIZZY_COUNTER,
            .chance = 30,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_CUTE : CONTEST_CATEGORY_BEAUTY,
