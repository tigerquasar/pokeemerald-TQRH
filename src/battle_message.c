...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNENERGYRESTOREDBYPOWDER]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} restored its own HP!"),
    ...
    [STRINGID_PKMNDIZZY]                            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became dizzy!"),
    ...
    [STRINGID_PKMNBITTEN]                           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was bitten by {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PKMNNOLONGERBITTEN]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} lets go of its bite."),
    ...
    [STRINGID_DIZZYENDS]                            = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} came to his senses!"),
...
const u16 gAbsorbDrainStringIds[] =
{
    ...
    [B_MSG_ABSORB_POWDER] = STRINGID_PKMNENERGYRESTOREDBYPOWDER,
};
